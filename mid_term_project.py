...
Original file is located at
    https://colab.research.google.com/drive/1X7uK0kbyLrcwTNggTOd48W4R3fNJhSV_
...
df_maindata = pd.read_excel(
    '/content/Sports Data.xlsx', sheet_name='Sports data for DSBA')
df_maindata.info()
...
def run(trial):
    ...
    for fold, (train_idx, val_idx) in enumerate(skfold.split(X, y)):
        ...
        model_xgb.fit(X_train, y_train, early_stopping_rounds=300,
...
df_test = df_test1.drop('result', axis=1).to_dict(orient='records')
